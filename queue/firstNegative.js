...
/**
 * sliding window techniqe  is used,
 * in queue, we are storing, the  index of the negative numbers
 * then in second for loop, we are checking with the index and the window index, then checkin whether it is negative number
 * then nothing gets done, we can print zero 
 */
